...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.textureWaterT = new CGFtexture(this, "textures/waterTex.jpg");
		this.textureWaterM = new CGFtexture(this, "textures/waterMap.jpg");
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/ex1.vert", "shaders/ex1.frag"),	/* exercise 1.1 */
			new CGFshader(this.gl, "shaders/ex2.vert", "shaders/ex2.frag"), /* exercise 1.2 */
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/gray.frag"), /* exercise 1.3 */
			new CGFshader(this.gl, "shaders/water.vert", "shaders/water.frag")	/* exercise 2 */
	...
	update(t) {
		...
		if (this.selectedExampleShader == 6 || this.selectedExampleShader == 10 || this.selectedExampleShader == 12)
			...
			this.testShaders[12].setUniformsValues({timeFactor: t / 200 % 100});
	}
	...
	display() {
		...
		this.textureWaterT.bind(2);
		this.textureWaterM.bind(3);
