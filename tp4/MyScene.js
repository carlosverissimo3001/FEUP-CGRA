...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.textureCima = new CGFtexture(this, 'images/mineTop.png');
        this.textureLado = new CGFtexture(this,'images/mineSide.png');
        this.textureBaixo = new CGFtexture(this, 'images/mineBottom.png');

        this.unitCube = new MyUnitCubeQuad(this, this.textureCima, this.textureLado, this.textureLado, this.textureLado, this.textureLado, this.textureBaixo); 
        //-------
